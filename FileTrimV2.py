...
def trim_file():
    ...
    data.drop(["Revision Date", "Revision Number", "Active User", "Middle Name", "Assignment Type ID",
               ...
               "Job Code ID", "Employee Status ID", "Employee Status", "Employee Type ID",
               "Employee Type", "Manager Middle Name"], axis=1, inplace=True, errors='ignore')
    os.chdir(out_path)
    head, filename = os.path.split(filename)
    data.to_csv("TRIMMED "+filename)
